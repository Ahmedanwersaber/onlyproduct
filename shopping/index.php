		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over د.ك 600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<!-- <li><a href="#stock" data-toggle="tab">Stock Products</a></li> -->
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					د.ك<?php echo htmlentities($row['productPrice']);?>			</span>
...
<!-------- second part of page of products ---------->
<br><br><br><br>
<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <!-- <h3 class="new-product-title pull-left">Featured Products</h3> -->
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">Pest Products</a></li>
					<!-- <li><a href="#stock" data-toggle="tab">Stock Products</a></li> -->
					<!-- <li><a href="#furniture" data-toggle="tab">Furniture</a></li> -->
				</ul><!-- /.nav-tabs -->
			</div>
